...
namespace UI
{
    public partial class PPAOrderDetails : Form
    {
        Connection_class ppaOrderConn = new Connection_class();

        public PPAOrderDetails()
        {
            InitializeComponent();
        }

        private void PPAOrderDetails_Load(object sender, EventArgs e)
        {
